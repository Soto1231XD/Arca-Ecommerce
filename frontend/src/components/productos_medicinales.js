    ...
    <table className="table">
      ...
      <tbody>
        <tr>
          <th scope="row">1</th>
          <td>
            <img src="assets/img/medicina.png" width="15%" />
          </td>
          <td>Otto</td>
          <td>@mdo</td>
          <td>$100</td>
          <td>Agregar</td>
          <td>
          <Link to="/ver_producto_medicinales" style={{ color: 'black', textDecoration: 'none' }}>producto</Link>
          </td>
        </tr>
        <tr>
          <th scope="row">2</th>
...
export default ProductosMedicinales;
