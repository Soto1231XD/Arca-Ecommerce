...
function ServiciosMedicinales () {
    return(
        <>
  <title>Seccion de servicios</title>
  {/* Required meta tags */}
  <meta charSet="utf-8" />
  <meta
    name="viewport"
      ...
      >
          ...
          <div className="card square-card">
            ...
            <div className="card-body">
              <h5 className="card-title">
                -VACUNAS- Lorem Ipsum is simply dummy text of the printing and
        ...
        <div className="col-md-3">
          <div className="card square-card">
            ...
            <div className="card-body">
              <h5 className="card-title">
                -CIRUGIA- Lorem Ipsum is simply dummy text of the printing and
                typesetting industry. Lorem Ipsum has been the industry's
                standard dummy text ever since the 1500s, when an unknown
                printer took a galley of type and scrambled it to make a type
                specimen book.
        ...
        <div className="col-md-3">
          <div className="card square-card">
            ...
            <div className="card-body">
              <h5 className="card-title">
                -RADIOGRAFIA- Lorem Ipsum is simply dummy text of the printing
...
export default ServiciosMedicinales;